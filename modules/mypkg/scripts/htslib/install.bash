...
if [[ $(uname) == "Linux" && $(arch) == "x86_64" ]]; then
    download_link="https://github.com/samtools/htslib/releases/download/1.24/htslib-1.24.tar.bz2"
else
...
echo "Htslib 1.24 installed, add following to PATH:"
echo
echo "  /home/panyq/.dotfiles/modules/mypkg/packages/htslib-1.24/bin"
echo
